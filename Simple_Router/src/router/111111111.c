...
void sr_handlepacket(struct sr_instance *sr,
    ...
    /* It's a IP Packet type*/
        ...
        forward_ip(sr, ip_hdr, eth_hdr, packet, len, if_curr);
    }
...
void forward_ip(struct sr_instance *sr, sr_ip_hdr_t *ip_hdr, sr_ethernet_hdr_t *eth_hdr, uint8_t *packet, unsigned int len, struct sr_if *if_curr)
{
